...
namespace EVSTAR.Models
{
    public class CoveredProduct
    {
        ...
        public long RepairShoprAssetID { get; set; }
        ...
        public CoveredProduct(SqlDataReader r) : base()
        {
            ...
            ProductAdded = CoverageDate.ToShortDateString();
            RepairShoprAssetID = DBHelper.GetInt64Value(r["RepairShoprAssetID"]);
            EquipmentID = DBHelper.GetInt32Value(r["EquipmentID"]);
        }
    }
}