...
<body>
	<form runat="server">
		...
		<label>
			<input type="checkbox" id="cb_autocommit" />Auto Commit</label>
			...
			<div class="modal-dialog" style="width: 670px">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button class="btn btn-success" onclick="setTimeout(CameraCommit,1);return false;" id="btnCameraCommit">Commit</button>
		...
		<script>
			...
			function CameraCapture() {
				...
				if (document.getElementById("cb_autocommit").checked) {
					CameraCommit();
				}
			}
