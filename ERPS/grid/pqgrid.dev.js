...
function(t) {
    ...
    a.setData = function(t) {
        ...
        var e, n, r, i, o = this,
            ...
            S = [],
            E = [];
        for (x = null == x ? null == a.track ? w.on : a.track : x,
                ...
                for (v = 0; E > v; v++) {
                    ...
                    for (S = k, U = 0; S > U; U++) {
                        ...
                        var G = U + w,
                            ...
                            Q = j[z],
                            X = K.dataIndx;
                        K.copy !== !1 ? (z++, N[X] = Q, L && (L[X] = u(V, K))) : (W++, "extend" == T && g > S + w && S++)
                    }
...
function(t) {
    ...
    n.prototype = t.extend({}, pq.mixin.ChkGrpTree, pq.mixin.GrpTree, {
        ...
        filter: function(t, e, n, r, i, o) {
            for (var a, l, s, d, c = this, u = c.childstr, h = c.Model.filterShowChildren, f = 0, p = t.length; p > f; f++) {
                if (a = t[f], l = !1, d = a[u]) {
                    if (h && n.isMatchRow(a, e, r)) {
                        c.eachChild(a, function(t) {
                            i.push(t)
                        }), s = !0;
                        continue
                    }
                    l = c.filter(d, e, n, r, i, o), l && (s = !0, i.push(a))
                }
                l || (n.isMatchRow(a, e, r) ? (s = !0, i.push(a)) : o.push(a))
            }
            return s
        },
        getFormat: function() {
