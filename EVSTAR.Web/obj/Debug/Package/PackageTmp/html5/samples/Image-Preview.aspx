...
<head id="Head1" runat="server">
	<title>Drag and drop - Preview & Crop</title>
	<style>
		body {
			text-align: center;
			margin-top: 20px;
...
<body>
	<form id="form1" runat="server">
		<div class="content">
			...
			<h2>Drag and drop - Preview & Crop</h2>
			...
			<img id="imgtemp" style="float: right; border: solid 2px red; margin: 20px; display: none;" />
	...
	<script type="text/javascript">
		...
		function CuteWebUI_AjaxUploader_OnSelect(files) {
			...
			option.onmousestart = function () {
				imgtemp.style.display = 'block'
			}
			option.onmousestop = function () {
