<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site_Evstar.Master" AutoEventWireup="true" CodeBehind="SubmitDetails.aspx.cs" Inherits="Techcycle.Web.SubmitDetails" %>
            ...
            <div class="login-content-desktop" style="width: 750px; height: 750px;">
                ...
                <div class="login-button-row-desktop" style="order: 5; gap: 150px;">
                    ...
                    <div class="save-button-desktop btn-default" id="btnSubmitDetails" style="width: 160px;">
                        <span class="save-button-text-desktop" style="width: 65px;">
                            <span class="save-button-text-inner-desktop" style="width: 65px;" id="lblSubmitButton">Submit</span>
                        </span>
                    </div>
                </div>
            </div>
