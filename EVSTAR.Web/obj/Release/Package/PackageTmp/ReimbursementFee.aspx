<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site_Evstar.Master" AutoEventWireup="true" CodeBehind="ReimbursementFee.aspx.cs" Inherits="Techcycle.Web.ReimbursementFee" %>
            ...
            <div class="verify-content-desktop" style="gap: 40px;">
                <div class="login-content-text-field1-desktop" style="order: 1; width: 800px;">
                    <div class="verify-content-rb1-desktop" id="radVerSms">
                        <input type="checkbox" name="verification" value="sms" class="verify-content-rb-desktop">
                        <label id="lblReimburseFeeAccept" class="verify-content-rb-text-desktop">By clicking this box you are acknowledging that a service fee of $49 will be deducted from your reimbursement payment.</label>
                    </div>
                </div>
                <div class="verify-spacer-desktop" style="order: 2;">
                </div>
                <div class="verify-button-row-desktop" style="position: absolute; top: 500px;">
                    <div class="button-back-desktop" id="btnReimburseFeeBack">
                        <span class="button-back-text-desktop"><span class="button-back-text-inner-desktop">Back</span></span>
                    </div>
                    <div class="verify-button-desktop btn-default" id="btnReimburseFee" disabled="disabled">
