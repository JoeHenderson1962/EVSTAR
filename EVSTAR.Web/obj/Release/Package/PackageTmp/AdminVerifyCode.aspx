<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site_Evstar.Master" AutoEventWireup="true" CodeBehind="AdminVerifyCode.aspx.cs" Inherits="Techcycle.Web.AdminVerifyCode" %>
        ...
        <div class="verify-panel-desktop">
            <div class="verify-content-desktop">
                ...
                <div class="verify-button-row-desktop">
                    <div class="button-back-desktop" id="btnAdminVerifyCodeBack">
                        <span class="button-back-text-desktop"><span class="button-back-text-inner-desktop">Back</span></span>
                    </div>
                    <div class="verify-button-desktop btn-default" id="btnAdminVerifyCode">
