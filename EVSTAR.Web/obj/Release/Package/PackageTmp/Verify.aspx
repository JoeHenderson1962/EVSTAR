<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site_Evstar.Master" AutoEventWireup="true" CodeBehind="Verify.aspx.cs" Inherits="Techcycle.Web.Verify" %>
        ...
        <div class="verify-panel-desktop">
            <div class="verify-content-desktop">
                ...
                <div class="verify-button-row-desktop">
                    <div class="button-back-desktop" id="btnSendVerificationBack">
                        <span class="button-back-text-desktop"><span class="button-back-text-inner-desktop">Back</span></span>
                    </div>
                    <div class="verify-button-desktop btn-default" id="btnSendVerification">
                ...
                <div class="verify-wait-row-desktop" style="display:none;" id="divWaitVerify">
                    <p>
                        Please wait. Do not click the "Continue" button again.
                    </p>
                </div>
            </div>
        </div>
