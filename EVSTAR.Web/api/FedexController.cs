    ...
    public class FedexController : ApiController
    {
        ...
        private string CreateShipment(string bearerToken)
        {
            ...
            try
            {
                ...
                shipment.requestedShipment.recipients[0].contact = new Models.FedEx.Contact();
                ...
                shipment.requestedShipment.recipients[0].address = new Models.FedEx.Address();
                ...
                shipment.requestedShipment.shipper.address = new Models.FedEx.Address();
                ...
                shipment.requestedShipment.shipper.contact = new Models.FedEx.Contact();
