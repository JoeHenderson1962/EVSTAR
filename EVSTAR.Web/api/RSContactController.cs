...
namespace EVSTAR.Web.api
{
    public class RSContactController : ApiController
    {
            ...
            if (email.Length > 0)
            {
                ...
                if (users.portal_users.Count > 0)
                {
                    ...
                    if (cust != null && cust.customer != null && cust.customer.properties != null)
                    {
                        ...
                        {
                            foreach (Models.Contact contact in cust.customer.contacts)
                            {
        ...
        // PUT api/<controller>
        public string Put([FromBody] Models.Contact contact)
        {
        ...
        public async Task<string> PutContact(Models.Contact contact, int id)
        {
