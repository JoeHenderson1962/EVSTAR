...
namespace EVSTAR.Web.api
{
    public class PaymentController : ApiController
    {
        ...
        private void UpdateCCTransaction(CCTransaction value)
        {
            ...
            sql.AppendLine("State=@State, PostalCode=@PostalCode, Amount=@Amount, ");
            ...
            sql.AppendLine("TransactionDateTime=@TransactionDateTime, TransactionID=@TransactionID, Response=@Response, Status=@Status, ");
